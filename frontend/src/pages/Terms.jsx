export default function Terms() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-16">
      <h1 className="text-center text-3xl font-bold text-brand">Terms and Conditions</h1>

      <div className="mt-8 space-y-5 text-gray-700">
        <p>Welcome to indooraxe.in!</p>

        <p>
          These terms and conditions outline the rules and regulations for the use of Indooraxe pvt ltd's Website,
          located at https://www.indooraxe.in/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use
          indooraxe.in if you do not agree to take all of the terms and conditions stated on this page.
        </p>
        ...
        <p>
          ...
          provision of the Company's stated services, in accordance with and subject to, prevailing law of in. Any
        ...
        <h3 className="pt-4 text-xl font-bold text-brand">Cookies</h3>

        <p>
          We employ the use of cookies. By accessing indooraxe.in, you agreed to use cookies in agreement with the
          Indooraxe pvt ltd's Privacy Policy.
        </p>
        ...
        <h3 className="pt-4 text-xl font-bold text-brand">License</h3>

        <p>
          Unless otherwise stated, Indooraxe pvt ltd and/or its licensors own the intellectual property rights for
          all material on indooraxe.in. All intellectual property rights are reserved. You may access this from
          indooraxe.in for your own personal use subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul className="list-disc space-y-1 pl-6">
          <li>Republish material from indooraxe.in</li>
          <li>Sell, rent or sub-license material from indooraxe.in</li>
          <li>Reproduce, duplicate or copy material from indooraxe.in</li>
          <li>Redistribute content from indooraxe.in</li>
        </ul>
        ...
        <p>
          ...
          certain areas of the website. Indooraxe pvt ltd does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and opinions of Indooraxe pvt ltd,its
          agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Indooraxe pvt ltd shall not be liable for the
          Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
        </p>

        <p>
          Indooraxe pvt ltd reserves the right to monitor all Comments and to remove any Comments which can be
        ...
        <p>
          You hereby grant Indooraxe pvt ltd a non-exclusive license to use, reproduce, edit and authorize others to
          use, reproduce and edit any of your Comments in any and all forms, formats or media.
        </p>

        <h3 className="pt-4 text-xl font-bold text-brand">Hyperlinking to our Content</h3>
        ...
        <p>
          ...
          absence of Indooraxe pvt ltd; and (d) the link is in the context of general resource information.
        </p>
        ...
        <p>
          ...
          website, you must inform us by sending an e-mail to Indooraxe pvt ltd. Please include your name, your
        ...
        <p>No use of Indooraxe pvt ltd's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>

        <h3 className="pt-4 text-xl font-bold text-brand">iFrames</h3>
        ...
        <h3 className="pt-4 text-xl font-bold text-brand">Content Liability</h3>
        ...
        <h3 className="pt-4 text-xl font-bold text-brand">Reservation of Rights</h3>
        ...
        <h3 className="pt-4 text-xl font-bold text-brand">Removal of links from our website</h3>
        ...
        <h3 className="pt-4 text-xl font-bold text-brand">Disclaimer</h3>
