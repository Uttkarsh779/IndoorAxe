export default function Privacy() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-16">
      <h1 className="text-center text-3xl font-bold text-brand">Privacy Policy for Indooraxe pvt ltd</h1>

      <div className="mt-8 space-y-5 text-gray-700">
        <p>
          At indooraxe.in, accessible from https://www.indooraxe.in/, one of our main priorities is the privacy of
          our visitors. This Privacy Policy document contains types of information that is collected and recorded by
          indooraxe.in and how we use it.
        </p>
        ...
        <p>
          ...
          regards to the information that they shared and/or collect in indooraxe.in. This policy is not applicable
          to any information collected offline or via channels other than this website.
        </p>

        <h2 className="pt-4 text-xl font-bold text-brand">Consent</h2>
        <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

        <h2 className="pt-4 text-xl font-bold text-brand">Information we collect</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-brand">How we use your information</h2>
        ...
        <h2 className="pt-4 text-xl font-bold text-brand">Log Files</h2>
        <p>
          indooraxe.in follows a standard procedure of using log files. These files log visitors when they visit
        ...
        <h2 className="pt-4 text-xl font-bold text-brand">Advertising Partners Privacy Policies</h2>
        <p>You may consult this list to find the Privacy Policy for each of the advertising partners of indooraxe.in.</p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
          used in their respective advertisements and links that appear on indooraxe.in, which are sent directly to
        ...
        <p>Note that indooraxe.in has no access to or control over these cookies that are used by third-party advertisers.</p>

        <h2 className="pt-4 text-xl font-bold text-brand">Third Party Privacy Policies</h2>
        <p>
          indooraxe.in's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        <h2 className="pt-4 text-xl font-bold text-brand">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
        ...
        <h2 className="pt-4 text-xl font-bold text-brand">GDPR Data Protection Rights</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-brand">Children's Information</h2>
        <p>
        ...
        <p>
          indooraxe.in does not knowingly collect any Personal Identifiable Information from children under the age
        ...
        <h2 className="pt-4 text-xl font-bold text-brand">Changes to This Privacy Policy</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-brand">Contact Us</h2>
